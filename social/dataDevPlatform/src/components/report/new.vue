<template>
	<div class="content-new">
			...
			<div class="form-group form-project">
				...
				<div class="menu-con" v-show="openPro">
					...
					<ul v-show="projects" class="projects-list">
					    <li v-for="item in projects"><a @click="choose('project', item)">{{item.PN}}</a></li>
					</ul>
				</div>
			</div>
			<div class="form-group form-members" v-show="false">
		...
		<div class="bottom-form">
			<input type="submit" value="创建报表" class="btn btn-success" @click="creatReport()" :class="{disabled: !reportInfo.name || !reportInfo.desc || !belongTo}" :disabled="(!reportInfo.name || !reportInfo.desc || !belongTo)">
