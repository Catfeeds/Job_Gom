...
var share = function(node) {
	...
	var nodeEvent = {
		...
		// shareDialog.go({type:'weixins',url:'http://www.gomeplus.com',title:'国美Plus'});
	$node.on({
