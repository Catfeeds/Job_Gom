...
/***/ function(module, exports, __webpack_require__) {
	...
	var returnGoods = __webpack_require__(251);
	returnGoods.init();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var extGoMsg = ["无理由退换货", "质量问题", "发错商品", "工艺做工瑕疵", "商品开箱残", "商品与描述不符", "商品配件少件/破损/污渍等", "安装环境受限", "安装不及时/安装态度差等", "物流服务态度差/配送不及时等", "拒收问题", "二次销售", "特殊退换货", "其他原因"];
	// 缺少退换货文案
	...
	function OnGoodOption() {
	   ...
	   if ($this.hasClass("curBtn") || $this.hasClass("disabled")) {
	      // 屏蔽当前的，或者不可点击的
	      return false;
	   } else {
