<div class="ui-body-box">
  <div class="invoice-box">
    ...
    <div class="invoice-flot-lft">
      <label data-node="noInvoice" data-type="0" {{if type>0}}class="gm-gray"{{/if}}><span class="menu-radio {{if type==0}}menu-radio-checked{{/if}}"></span>不开票</label>
    </div>
    <div class="invoice-flot-lft">
  ...
  <div data-node="openInvoiceBox" class="{{if type==0}}hide{{/if}}">
  	...
  	<div class="please-enter"><em data-action="clear" class="iconn-7"></em>
  	  <input data-node="invoiceInfo" data-type="{{type}}" type="text" value="{{title}}" placeholder="请输入发票抬头" class="input-error">
  	  <p class="error"><em class="iconn-25"></em>请输入发票抬头信息</p>
  	</div>
