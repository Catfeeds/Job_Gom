            ...
            if (com.isLogin()) {
                ajax.postData('/car/shopnum', null,function (data) {
                    if (data.code == 0||data.code == 200) {
                        ...
                        if (num > 0) {
                            $('#num').show().html(num);
                            $('#listCar span').show().html(num);
                            if (num > 999) {
                                $('#num').html("···").css({'font-size': '20px', 'line-height': '20px'});
                                $('#listCar span').html("···").css({'font-size': '20px', 'line-height': '20px'});
                ...
                if (cars) {
                    ...
                    if (num > 0) {
                        $('#num').show().html(num);
                        if (num > 999) {
                            $('#num,#listCar span').html("···").css({'font-size': '30px', 'line-height': '18px'});
                        }
                    }
                }
            }
