define('conf/read/read.js', function (require) {
    require('$');
    ...
    //分享参数;
    var title='【国美Plus】尽享阅读 褪却浮尘';
    var link=shareUrl;
    var desc='社交还是独处  ，尽享阅读 褪却浮尘~';
    var imgUrl=shareImgUrlPrefix+'/images/module/h5-read/share.jpg';
    ...
    //页面埋点js
    BP.send({event_id:'P726H001',url:coquetryUrl,name:'活动页面',cook_id:'',user_id:''});
    $('body').on('click', '.read-shop',function(){
