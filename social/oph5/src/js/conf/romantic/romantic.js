define('conf/romantic/romantic.js', function (require) {
    require('$');
    ...
    //分享参数;
    var title='浪漫季 天天都是情人节';
    var link=shareUrl;
    var desc='刚刚过完七夕身体被掏空了吗？浪漫季节，只要你想天天都是情人节哦~ 更多惊喜优惠齐聚国美Plus！';
    var imgUrl=shareImgUrlPrefix+'/images/module/h5-romantic/share.jpg';
    ...
    //页面埋点js
    BP.send({event_id:'P811W001',url:coquetryUrl,name:'活动页面',cook_id:'',user_id:''});
    $('body').on('click', '.romantic-shop',function(){
