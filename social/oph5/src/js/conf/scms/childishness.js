define('conf/scms/childishness.js', function (require, exports, module) {
    //
    require('$');
    ...
    oTitle = '童心飞扬 欢乐无限',
    oDesc = '童年就像五彩斑斓的珍珠，拥有无尽的欢乐和幻想~',
    imgPre =  cssPre.replace('https','http'),
    oImgUrl = imgPre+'/images/module/scms/childishness/share.jpg';
    console.log(oImgUrl)
    //weixin
	wx.ready(function () {
    ...
    //页面埋点js
    BP.send({event_id:'PA1008W01',url:coquetryUrl,name:'活动页面',cook_id:'',user_id:''});

    // 点击跳转
    $('body').on('click', '.childishness-sec a',function(){
