define('conf/liqiu/liqiu.js', function (require) {
    require('$');
    ...
    //分享参数;
    var title='【国美Plus】伤春不悲秋，全民贴秋膘~';
    var link=shareUrl;
    var desc='立秋都到啦！天气辣么冷，囤肉好过冬~';
    var imgUrl=shareImgUrlPrefix+'/images/module/h5-liqiu/share2.jpg';
    ...
    //页面埋点js
    BP.send({event_id:'P804W001',url:coquetryUrl,name:'活动页面',cook_id:'',user_id:''});
    $('body').on('click', '.liqiu-shop',function(){
    ...
    $('.moreA').on('click',function(){
        var producturl = $(this).attr('producturl');
        BP.send({event_id:'B804W001',url:coquetryUrl,name:'更多活动位',cook_id:'',user_id:''});
        location.href = producturl;
    })
    //下拉刷新
