define('conf/keep/keep.js', function (require) {
    require('$');
    ...
    var title='养生原动力';
    var link=shareUrl;
    var desc='国美Plus优质选茶健康添活力，黄金配比享受清凉夏日，更多夏日爆品尽在国美Plus';
    var imgUrl=shareImgUrlPrefix+'/images/module/h5-keep/share.jpg';
    ...
    //页面埋点js
    BP.send({event_id:'P722W001',url:coquetryUrl,name:'活动页面',cook_id:'',user_id:''});
    $('body').on('click', '.keep-shop',function(){
