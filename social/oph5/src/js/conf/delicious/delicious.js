define('conf/delicious/delicious.js', function (require) {
    require('$');
    ...
    oTitle = '随时随地 发现美妙滋味',
    oDesc = '吃货们，燥起来吧！美妙好滋味，各类爆款零食大集结，只等你来!',
    imgPre =  cssPre.replace('https','http'),
    oImgUrl = imgPre+'/images/module/delicious/share.jpg';
    console.log(oImgUrl)
    //weixin
	wx.ready(function () {
    ...
    //页面埋点js
    BP.send({event_id:'PA0902A01',url:coquetryUrl,name:'活动页面',cook_id:'',user_id:''});

    // 点击跳转
    $('body').on('click', '.delicious-sec a',function(){
