...
const specialRoutes = [
  ...
  },
  {
    ...
    beforeEnter:function(to,from,next){
      /*if(from.name == 'wcqk' || from.name =='hfzt'){
        console.log('zhengxiang')
        store.commit('setRecordEnd', store.state.zxOptions.member.type);
      }else if(from.name == 'zxxq'){
        console.log('从详情来');
        store.commit('setRecordEnd', store.state.zxOptions.recordNum);
      }*/
