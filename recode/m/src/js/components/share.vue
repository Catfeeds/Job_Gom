    ...
    export default {
        ...
        data() {
            return {
                ...
                isWeiBo: false,
                isShowShare: true,
                qq_zone_titles: qq_zone_title,
                qq_zone_descs: qq_zone_desc,
                qq_zone_links: qq_zone_link,
                qq_zone_imgs: qq_zone_img,
                sina_titles: sina_title,
                sina_descs: sina_desc,
                sina_links: sina_link,
                sina_imgs: sina_img,
            }
        },
        created() {
