...
$(function () {
  var Double12 = {
    ...
    gotoSendWarmPage: function gotoSendWarmPage() {
    ...
    startSendWarm: function startSendWarm(e) {
    ...
    moveSendWarm: function moveSendWarm(e) {
      if (!this.isInScale) {
        return;
      }
      e.preventDefault();
    ...
    endSendWarm: function endSendWarm(e) {
      this.isInScale = false;
    },
    ...
    postScore: function postScore(score) {
      var _this = this;
      $.ajax({
        url: "/api/incrWarm",
        type: "post",
    ...
    rePostScore: function rePostScore(score) {
      if (this.retryTime > 1) {
        return;
      }
      this.retryTime++;
    ...
    gotoSendWarmResult: function gotoSendWarmResult(score) {
      if (score > 0) {
    ...
    gotoSendWarmSuccessPage: function gotoSendWarmSuccessPage(score) {
    ...
    gotoSendWarmFailPage: function gotoSendWarmFailPage() {
      this.pageSendWarm.addClass("hide");
