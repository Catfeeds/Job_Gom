<template>
	...
	&lt;/script>
			...
			<div class="show-info">
				...
				<label class="btn" for="upload3">upload</label>
				<input type="file" id="upload3" style="position:absolute; clip:rect(0 0 0 0);" accept="image/png, image/jpeg, image/gif, image/jpg" @change="uploadImg($event, 3)">
