...
<div class="circle-bj" data-small="circle-bjS">
    <div class="circle-con-box" data-node="circleBox">
        ...
        <div class="div-input"><span data-node="nameLength">0/15</span>
            <input class="write-name" type="text" placeholder="填写圈子名称" data-node="inputName">
        </div>
        <p class="circle-selected circle-name pad-top10"><em data-node="circle-selected">选择圈子分类</em><span data-node="circle-selected-classify">选择兴趣分类，便于相同兴趣爱好的人查找（单选，必填）                    </span></p>
        ...
        <div class="introduce-textarea" data-node="introduce-textarea"><span data-node="introduce-textareaNum">0/500</span>
            <textarea class="write-introduce" data-node="textarea-info" placeholder="请输入圈子简介" data-node="introduction"></textarea>
        </div>
        <p class="pad-top10">上传圈子头像<span>请上传JPG/PNG/JPEG格式的图片（选填）</span></p>
        <div class="circle-head">
            <div class="error" data-node="error">＊请上传小于4M的图片，支持格式jpg、jpeg、png！</div>
            <div class="upload-head-bx">
              ...
              <div class="picture-bj-img ">
                ...
                <div class="circle-default-head" data-node="cropWrap" >
                    ...
                    <img src="<{$pcimgpath}>/images/public/circle-default-head.jpg" alt="" data-default="<{$pcimgpath}>/images/public/circle-default-head.jpg" data-edit="btn"/>
                </div>
              </div>
                <div class="pc-btn-box">
                    <a class="pc-btn-amend pc-bj-fc8753 pc-btnw80 pc-btnh35" href="javascript:" data-action="upload-edit">修改</a>
