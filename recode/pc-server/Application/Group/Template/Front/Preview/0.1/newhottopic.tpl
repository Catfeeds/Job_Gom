...
<ul class="clearfix">
    <volist name="datalists" item="hotTopic" key="topicKey" offset="0" length='3'>
        <li>
            ...
            <div class="hotTop-matter">
                <div class="matter-title">
                    <a href="<{$hotTopic.topic_id|topicDetailUrlGen}>" target="_blank" title="<{$hotTopic.name}>" data-code="fresh01001-<{$topicKey+1}>"><{$hotTopic.name}></a>
                </div>
