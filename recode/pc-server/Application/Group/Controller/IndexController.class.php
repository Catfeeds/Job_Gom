...
//	    $url = 'https://i4.meixincdn.com/v1/img/T1U.KvB5LT1RXrhCrK.jpg.285x185cTzq80.jpg';
////	    $url = 'https://i6.meixincdn.com/v1/img/T1TtCTBmZT1R4cSCrK.png.100x100cTzq80.jpg';
//        $result = getResizeImg($url,100,56);
//        echo $result;exit;
