...
<body class="opg lg-bg">
    ...
    <div class="lg-main">
      ...
      <!--步骤 结束-->
      <div class="lg-form">
        <h4 class="lg-succ-top"><em class="iconn-20"></em>更新成功！</h4><span class="congratulation">恭喜您！您的新密码已设置成功，为保证您购物安全，建议您定期更改密码以保护账户安全。</span><a href="<{$passport_domain}>login" class="lg-btn-bor marg" data-action="skipPage">去登录</a>
      </div>
    </div>
