...
class ShopController extends BaseController
{
    ...
    //目前可以处理的tab类型,1：全部商品，2：上新商品
    private $tabArr = array(1, 2);
    ...
    public function index()
    {
        ...
        $this->assign('weixin_share', APP_HTTP.C('GOME')['URL']['MSHOP_URL'].'mshop-'.$param['shopId'].'.html'.'?h=shop&p=detail&shopId='.$param['shopId']);
        #拼接店铺二维码
    ...
    private function getShopQrCode($shopid)
    {
        ...
        else
        {
            ...
            return APP_HTTP.C('MAIN_URL').'ajax/qrcode/urlcode?url='.urlencode($url);
        }
    }
    ...
    public function search()
    {
        ...
        $this->assign('type', 3);      #控制搜索页不选中导航条
