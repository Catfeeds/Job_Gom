...
class SearchV2Service extends BaseService
{
    ...
    public $searchItemsInMshop = 'ext/item/searchItemsInMshop'; //美店搜索接口
    public $searchBrandInfo = 'brand/brand'; //品牌信息
    public $searchCategoryInfo = 'category/frontCategory';//分类信息
}
