...
/***/ (function(module, exports, __webpack_require__) {
	...
	var batchManage = __webpack_require__(61);
	var select = __webpack_require__(62);
	var delCollect = __webpack_require__(63);
	var loadMore = __webpack_require__(65);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var delSuccess = function delSuccess() {
	    $('[data-node=tiles]').html('');
	    page = 1;
	    loadMore.reload(page);
	    Pubsub('topicPage').pub(page);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var topicTpl = __webpack_require__(68);
	var noCollect = __webpack_require__(69);
	...
	//加载数据
	var resizeLoad = function resizeLoad(page) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports=template('src/js/page/collectTopic/loadMore/collectTopic',function($data,$filename
	/*``*/) {
	...
	$out+='</a></p> </div> </div> <div class="del-btn hide" data-node="delPopUp"> <div class="del-text"> <a class="btn-close" href="javascript:void(0);" data-action="cancelDel"></a> <p>确定要删除？</p> <div class="text-center"> <a href="javascript:void(0);" class="pc-btn" data-action="delOne">确定</a> <a href="javascript:void(0);" class="pc-btn pc-bj-fff" data-action="cancelDel">取消</a> </div> </div> </div> <div class="del-all hide" data-node="selectLayer"> <em class="icon-check" data-action="selectOne"></em> </div> </div> ';
	});
	$out+=' ';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var template=__webpack_require__(34);
	module.exports=template('src/js/page/collectTopic/loadMore/no_collect',function($data,$filename
	/*``*/) {
	'use strict';var $utils=this,$helpers=$utils.$helpers,$escape=$utils.$escape,groupDomain=$data.groupDomain,$out='';$out+='<div class="no-topic" data-node="empty"> <div class="txt clearfix"> <p><span>快去发现更多<a href="';
	$out+=$escape(groupDomain);
	$out+='channel/index.html" target="_blank">精彩话题</a>吧</span></p> </div> </div> ';
	return new String($out);
	});
...
//# sourceMappingURL=collectTopic.js.map