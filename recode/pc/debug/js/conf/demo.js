...
/***/ (function(module, exports, __webpack_require__) {
	...
	// 数字选择器
	var spinner = __webpack_require__(89);
	
	// 移除对话框时,记得清除对话框中绑定的事件
	// dialog使用方法
	// http://aui.github.io/artDialog/doc/index.html
	// 编辑收货人地址弹窗
	var deliveryAddrPop = __webpack_require__(90);
	...
	var circlePop = __webpack_require__(98);
	/*circlePop.create({
	...
	var dateFormat = __webpack_require__(104);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var truncate = __webpack_require__(71);
	var areaSelect = __webpack_require__(92); // 区域四级联动
	var alert = __webpack_require__(36);
	        ...
	        onshow: function onshow() {
	            ...
	            getGroups().done(function (json) {
	                ...
	                if (json && json.code === 200) {
	                    ...
	                    //数组去重
	                    var dupRemove = function dupRemove(useObj, contrastObj) {
	                        var arr = [];
	                        var dup = 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(created.length > 0){
	$out+=' <li class="clearfix" data-type="0"> <h4>我创建的圈子</h4> ';
	...
	$out+=' ';
	if(joined.length > 0){
	$out+=' <li class="clearfix" data-type="1"> <h4>我加入的圈子</h4> ';
	...
	$out+=' <li class="clearfix" data-type="2"> <h4>推荐圈子</h4> ';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var randomShowPic = function randomShowPic(type) {
		// var num;
		if (type == 'face') {
