{{each list as v i}}<p>&#8203<br></p><div data-node="gmp-ebox" class="card-box" contenteditable="false">
	<div data-type="insertGoods" data-skuId="{{v.skuId}}" data-pid="{{v.PId}}" data-info='{"type":"item","text":"","id":"{{v.PId}}","kid":"", "shopId": "{{v.shopId}}","skuId":"{{v.skuId}}"}'  class="publish-item">
