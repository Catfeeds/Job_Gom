						...
						<div className="login-form">
		                	...
		                	<div className="form-group">
								<div className="form-input">
									...
									<div className={this.state.userMessge ? "message show" : "message hide"}>1.长度为6-20个字符，支持字母、数字、及“-”、“_”<br/>2.不可以输入纯数字、纯符号</div>
							...
							<div className="login-link register-link">
								<span className="gray">点击注册即表示您同意</span>
								<a href="javascript:;" className="blue" onClick={this.showDialog.bind(this)}>《国美视频合作协议》</a>
								<p>
								    <span className="gray">已有账号?请</span><Link className="blue" to="/">登录</Link>
							    </p>
							</div>
