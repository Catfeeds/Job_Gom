	...
	render(){
		return (
			<div className="crumbs">
				<Link to="/portal/videoManage">视频管理</Link>
				<span>&gt;</span>
				<b>修改视频资料</b>
			</div>
		);
...
class UpdateForm extends Component {
            ...
            VideoService.update({
               ...
               if (data.code === 1) {
                   ...
                   that.notification.notice({
                       ...
                       onClose: function(){
                          that.props.history.replace('/portal/videoManage');
                       }
                   });
               } else {
                   that.notification.notice({
    ...
    cancel = ()=>{
        this.props.history.replace('/portal/videoManage');
    }
    ...
    render () {
        ...
        return (
            <div className="video-update">
                <div className="video-update-title">
                    <p>修改视频资料</p>
                </div>
                ...
                <div className="video-update-btns">
                    <button onClick={this.modify} className="vu-btn video-update-submit">提交</button>
                    <button onClick={this.cancel} className="vu-btn video-update-cancel">取消</button>
                </div>
            </div>
...
class VideoUpdate extends Component{
	...
	render(){
        ...
        if (this.state.id) {
            return (
                <div className="video-update-wrap">
                    <Crumbs />
                    <UpdateForm 
                        fetchData={()=>{}}
                        id={this.state.id}
