import * as imgReplace from './imgReplace';

// console.log(imgReplace.orignalImgReplace)

var $meidianTag = $("[data-node=show-meidian]");

// var porject = $GLOBAL_CONFIG['channel'] || '';      //项目：cenannel 美号
...
function fillComponents(ue, arrs, isPreview = false) {
