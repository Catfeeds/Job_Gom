...
export default {
  ...
  methods: {
    ...
    tMove (e) {
      ...
      vm.wHeight = document.documentElement.offsetHeight;
      vm.meHeight = window.innerHeight;
      vm.scTop = document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop;
      ...
      if (!vm.islockDown && moveDis <= 0&&vm.wHeight <= vm.meHeight + vm.scTop) {
        event.preventDefault()
        if (moveDis > -50) {
