...
<ul data-node="tab-title-goods" class="tab-title-goods">
  ...
  {{else}}
  <li data-node = "rec" class="active">好货推荐</li>
  {{/if}}
...
<div class="loading" data-node="searchLoading" style="display:none;"><img src="{{imgSrc}}/images/public/loading.gif" alt=""></div>
<div style="height:40px;text-align:center" data-node="search-item-tips">请搜索商品</div>
{{/if}}
<p class="failed-txt"  style="display:none;" data-node="searchFail">数据获取失败，点击重新加载！</p>
<div  style="display:{{(returnList.length === 0 ? 'none':'')}};" data-node="searchResultBox">
  <div class="merchant-list clearfix" >
