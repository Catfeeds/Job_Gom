...
function Scans(o) {
    ...
    this.$toolbarbox = $(this.$parent.ui.getDom('toolbarbox'));
    this.uploadMaxNum = o.maxLen || 20; //上传图片限制
...
Scans.prototype = {
    ...
    fixPop: function() {
        var $btn = this.$target;
        var toolbarOffset = this.$toolbarbox.offset();
        var offset = $btn.offset();

        return this.$showBox.css({
            'top': 50 + 'px',
            'left': offset.left - toolbarOffset.left  - 10 +  'px'
        });
