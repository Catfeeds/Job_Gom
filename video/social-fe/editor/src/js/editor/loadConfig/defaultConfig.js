...
function useEnvPath(){
	switch(process.env.NODE_ENV.env){
		...
		default:
			envPath = {
				jsDomain:'http://js.meixincdn.com/',
				jspath:'http://js.meixincdn.com/m/editor/dist',
				csspath:'http://js.meixincdn.com/m/editor/dist',
				imgpath:'http://js.meixincdn.com/m/editor/dist'
			}
			break;
	}
