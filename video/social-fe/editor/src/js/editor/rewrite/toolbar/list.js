        ...
        me.commands['insertunorderedlist'] = {
            execCommand: function(command, style) {
                ...
                var me = this,
                    ...
                    /************处理标签无故加粗、斜体、下划线,影响到了别的功能，先注释****************/
                    /*var s = [].concat(me.selection.getStartElementPath());
                    ...
                    var childNodes = s.childNodes
                    for(var i=0;i<childNodes.length;i++){
                        (function(i){
                            var node = childNodes[i];
                            lowerName = node.nodeName.toLowerCase()
                            if(lowerName == 'em' || lowerName =='strong' ||lowerName =='u'){
