...
const mutations = {
  ...
  getXmxqPageData(state, data) {
      ...
      let pageData = {
        ...
        //新增字段
        detailModules: resData.data.compName,
        detailProjectType: resData.data.taskTypeChn,
        detailProjectDiscrib: resData.data.description,
        detailSummary: resData.data.weekSummary,
        detailPlan: resData.data.nextWeekPlan,
        detailStars: parseInt(resData.data.score/10)/2,
        riskTypeChn:resData.data.riskTypeChn,
        //中心/部门
        departPname:resData.data.departPname,
        departName:resData.data.departName,
        depart:(resData.data.departPname&&resData.data.departName)
          ?(resData.data.departPname + '/'+resData.data.departName)
          :(resData.data.departPname + resData.data.departName)
      }
