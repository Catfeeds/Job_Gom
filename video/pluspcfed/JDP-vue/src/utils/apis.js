...
var apiObj = {
	...
	//搜索历史记录
	searchHistory: '/api/getSearchLog',
	//专项列表
	zxList: '/special/filterResult',
	zxSpeList: '/special/filterResultMonth',
	//附件
	zxFj: '/search/getSearchLog',

	/*专项接口*/
	pandect:'/special/pandect',//专项任务页接口
	proStatus:'/special/proStatus',//完成情况页接口
	replyStatus:'/special/reply',//回复状态
	wholeNum:'/special/wholeNum',//专项数
	proMonth:'special/getProByMonth'//月份专项
};
