...
var _Promise_ = function _Promise_() {
    this.then = function () {
        return this;
    };
    this.done = function () {
...
var fetch = function fetch(url, options) {
    ...
    if (defaults.validate) {
        var loginPop = __webpack_require__(15);
        var isLogin = __webpack_require__(9);
        if (!isLogin()) {
            loginPop(defaults);
...
var passport = __webpack_require__(202);
var mall = __webpack_require__(203);
var group = __webpack_require__(204);
var order = __webpack_require__(205);
var ucenter = __webpack_require__(206);
var activity = __webpack_require__(207);
var other = __webpack_require__(208);
var talent = __webpack_require__(209);
var meihao = __webpack_require__(210);
var meidian = __webpack_require__(211);
...
var _extend = function _extend(defaults) {
 ...
 */
var Popup = __webpack_require__(200);
    ...
    button: function button(args) {
        ...
        if (typeof args === 'string') {
            ...
            $.each(args, function (i, val) {
                ...
                html += '<a' + ' href="javascript:;"' + ' i-id="' + id + '"' + style + (val.disabled ? ' disabled' : '')
                // + (val.autofocus ? ' autofocus class="ui-dialog-autofocus"' : '')
                + ' class="' + btnCls + '"' + '>' + val.value + '</a>';

                that._$('button').addClass(that.options.btnWrapCls).on('click', '[i-id=' + id + ']', function (event) {
                    var $this = $(this);
...
var Pubsub = function Pubsub(channel) {
    var callbacks,
...
"use strict";
/* WEBPACK VAR INJECTION */(function($, __webpack_provided_window_dot_jQuery, $_CONFIG) {
...
var logined = function logined(fn) {
...
// 国美的浮层登录
var popGomeOnlineLogin = function popGomeOnlineLogin(loginCb) {
    if (!window.g) {
...
var setPageId = function setPageId(id) {
	window._page_id_ = id;
};
...
var setPageData = function setPageData(name) {
	var data = map[name];
	if (data) {
		setPageId(data.id);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(GER, $_CONFIG) {

var gomeGER = new GER({
    url: $_CONFIG['group_domain'] + 'ajax/log/index?err_msg=',
    proxyJquery: true,
    proxyTimer: true,
    except: [/^Script error\.?/, /^Javascript error: Script error\.? on line 0/, function () {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(150), __webpack_require__(1)))
...
//返回顶部
var init = function init(els, showHight) {
...
module.exports = {
    ...
    innerHTML: '<div i="dialog" class="ui-dialog">' + '<div class="ui-dialog-arrow-a"></div>' + '<div class="ui-dialog-arrow-b"></div>' + '<table class="ui-dialog-grid">' + '<tr>' + '<td i="header" class="ui-dialog-header">' + '<button i="close" class="ui-dialog-close icon icon-close" title="关闭">&#215;</button>' + '<div i="title" class="ui-dialog-title"></div>' + '</td>' + '</tr>' + '<tr>' + '<td i="body" class="ui-dialog-body">' + '<div i="content" class="ui-dialog-content"></div>' + '</td>' + '</tr>' + '<tr>' + '<td i="footer" class="ui-dialog-footer">' + '<div i="statusbar" class="ui-dialog-statusbar"></div>' + '<div i="button" class="ui-dialog-button"></div>' + '</td>' + '</tr>' + '</table>' + '</div>'
...
}, _defineProperty(_module$exports, 'getNextTopic', '/api/next_topic/'), _defineProperty(_module$exports, 'topicDel', '/ajax/topic/del'), _defineProperty(_module$exports, 'topicReport', '/ajax/topic/report'), _defineProperty(_module$exports, 'categories', '/api/categories'), _defineProperty(_module$exports, 'groupLists', '/api/group_lists'), _defineProperty(_module$exports, 'recommendCircle', '/api/recommend'), _defineProperty(_module$exports, 'exitCircle', '/ajax/group/quit_circle'), _defineProperty(_module$exports, 'topicRotateImg', '/ajax/topic/handleImg'), _defineProperty(_module$exports, 'topListenImg', '/ajax/topic/checkinfo'), _defineProperty(_module$exports, 'topicBase64Upload', '/ajax/topic/path'), _defineProperty(_module$exports, 'topicuploadMax', '/ajax/topic/putMaxNum'), _defineProperty(_module$exports, 'topicUrlUpload2', '/ajax/topic/url'), _defineProperty(_module$exports, 'h5TopicUpload', '/ajax/topic/upload'), _defineProperty(_module$exports, 'h5QruploadStatus', '/qrupload/statreport'), _defineProperty(_module$exports, 'h5QruploadMaxNum', '/qrupload/maxNum'), _defineProperty(_module$exports, 'tagSearch', '/ajax/tag/search'), _defineProperty(_module$exports, 'tagCreate', '/ajax/tag/create'), _defineProperty(_module$exports, 'sensitiveWord', '/ajax/topic/check'), _defineProperty(_module$exports, 'readTopicData', '/expert/publishedDetail'), _defineProperty(_module$exports, 'readTopicDraftsData', '/expert/draftsDetail'), _defineProperty(_module$exports, 'addVisitTopic', '/ajax/api/otherMissing'), _defineProperty(_module$exports, 'getVideoPath', '/ajax/meihao/getVideoInfo'), _defineProperty(_module$exports, 'setTop', '/ajax/topic/actopic'), _defineProperty(_module$exports, 'shareKid', '/ajax/Mshop/getmshopKid'), _defineProperty(_module$exports, 'deleteDiscuss', '/ajax/topic/first_v2_del'), _defineProperty(_module$exports, 'deleteSecondDiscuss', '/ajax/topic/second_v2_del'), _defineProperty(_module$exports, 'getTopicList', '/ajax/topic/relatedTopics'), _defineProperty(_module$exports, 'commentListMd', '/ajax/api/mshop_reply_list_v2'), _defineProperty(_module$exports, 'getRelyListMd', '/ajax/api/second_reply_list_v2'), _defineProperty(_module$exports, 'secondtopicMd', '/ajax/topic/mshop_second_v2'), _module$exports);
...
module.exports = {
   ...
   myMshop: '/ajax/Mshop/index',
   recomment: '/ajax/Mshop/addItem'
};
...
var searchInit = __webpack_require__(214);
var Pubsub = __webpack_require__(7);
var channel = __webpack_require__(14);
var loginPop = __webpack_require__(15);
var checkLoginStatus = __webpack_require__(9);
...
var analytic = function analytic(keyWord, s_type) {
    // 发送埋点数据
...
var searchKeyword = function searchKeyword(obj) {
