...
{{/if}}
    <div class="mg-negative">
        ...
        <div class="list-box">
	        ...
	        {{if value.textShow !== ""}}
	        <p class="list-description"><a href="{{list.groupDomain}}topic/{{value.id}}.html" target="_blank">
	        {{value.textShow}}</a></p>
	        {{/if}}
    ...
    <div class="del-btn hide" data-node="delPopUp">
        <div class="del-text">
        	<a class="btn-close" href="javascript:void(0);" data-action="cancelDel"></a>
            <p>确定要删除？</p>
                <div class="text-center">
                	<a href="javascript:void(0);" class="pc-btn" data-action="delOne">确定</a>
                	<a href="javascript:void(0);" class="pc-btn pc-bj-fff" data-action="cancelDel">取消</a>
                </div>
        </div>
    </div>
