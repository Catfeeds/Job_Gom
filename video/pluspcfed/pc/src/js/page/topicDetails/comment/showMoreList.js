...
var showMoreList = function() {
    ...
    if (objHtml === "查看回复...") {
        ...
        obj.html("查看回复...");
        obj.parent().prevAll('dl').eq(0).attr('data-showList', 0);
    }
    function checkUser(replyItem){
            ...
            if (replyCommentList.length > 2) {
                ...
                for (var i = 0; i < replyCommentList.length; i++) {
                    ...
                    var showCom = {
                        ...
                        "canDelete": checkUser(replyaList)
                    }
                ...
                appendHtml = '';
                obj.html("收起");
                obj.parent().prevAll('dl').eq(0).attr('data-showList', 1);
            } else {
                obj.addClass("hide");
