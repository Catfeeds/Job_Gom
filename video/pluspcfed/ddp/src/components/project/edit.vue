			...
			<form>
				<fieldset>
					<div class="col-sm-12">
						...
						<div class="col-sm-10">
							<input class="form-control" value="{{info.PN}}" v-model="info.PN">
						</div>
					</div>
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-10">
							<textarea class="form-control" maxlength="250" rows="3" style="width:100%; resize:vertical" v-model="info.PS">{{info.PS}}</textarea>
						</div>
					</div>
				</fieldset>
				...
				<fieldset class="features">
					...
					<div class="form-group">
						<div class="col-sm-2">
							...
							<div v-else>
								<div class="list-item-avatar-con lg-avatar" style="background-color: #cce7ff; color: #555">{{info.PN.substring(0,1).toUpperCase()}}</div>
							</div>
						</div>
						<div class="col-sm-10">
							<p class="light">
					...
					<div v-if="formInfo.length !== 0">
						<table class="table table-striped">
							...
							<tr v-for="item in formInfo">
								...
								<td>{{item.PN}}</td>
								<td>
									<button type="button" class="btn btn-sm btn-info" v-link="{name: 'editReport', params: {id: item.PI}}">编辑</button>
									<button type="button" class="btn btn-sm btn-danger" @click="showConfirm(item.ID)">删除</button>
								</td>
							</tr>
						</table>
