...
gulp.task('sass', function() {
  ...
  .on('error', sass.logError)
	.pipe(gulp.dest('../../../wireless-h5/plus-store-css'))
...
gulp.task('watch', function() {
  ...
  gulp.watch('*.pug', ['pug']);
  livereload.listen();
  gulp.watch(['../../../wireless-h5/plus-store-css/**',
              '../../../wireless-h5/plus-store-css/html/**',
              '../../../wireless-h5/plus-store-css/images']).on('del', livereload.changed);
