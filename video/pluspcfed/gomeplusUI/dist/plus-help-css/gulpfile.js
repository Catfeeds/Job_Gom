...
gulp.task('sass', function() {
  ...
  .pipe(gulp.dest('../../../wireless-h5/plus-help-css'))
...
gulp.task('watch', function() {
  ...
  gulp.watch('*.pug', ['pug']);
  livereload.listen();
  gulp.watch(['../../../wireless-h5/plus-help-css/**',
              '../../../wireless-h5/plus-help-css/html/**',
              '../../../wireless-h5/plus-help-css/images']).on('del', livereload.changed);
