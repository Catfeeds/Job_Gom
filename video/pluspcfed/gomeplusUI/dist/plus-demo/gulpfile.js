...
gulp.task('sass', function() {
  ...
  .on('error', sass.logError)
	.pipe(gulp.dest('../../../wireless-h5/plus-demo-css'))
...
gulp.task('watch', function() {
  ...
  gulp.watch('*.pug', ['pug']);
  livereload.listen();
  gulp.watch(['../../../wireless-h5/plus-demo-css/**',
              '../../../wireless-h5/plus-demo-css/**',
              '../../../wireless-h5/plus-demo-css/**']).on('del', livereload.changed);
