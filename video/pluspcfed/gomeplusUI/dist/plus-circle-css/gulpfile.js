...
gulp.task('sass', function() {
  ...
  .on('error', sass.logError)
	.pipe(gulp.dest('../../../wireless-h5/plus-circle-css'))
...
gulp.task('watch', function() {
  ...
  gulp.watch('*.pug', ['pug']);
  livereload.listen();
  gulp.watch(['../../../wireless-h5/plus-circle-css/**',
              '../../../wireless-h5/plus-circle-css/html/**',
              '../../../wireless-h5/plus-circle-css/images']).on('del', livereload.changed);
