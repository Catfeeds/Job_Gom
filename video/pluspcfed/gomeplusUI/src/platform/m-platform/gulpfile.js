...
gulp.task('sass', function() {
  return sass('sass/**/*.scss',{ sourcemap: true })
	...
	.pipe(gulp.dest('../../../../m-platform/sass'))
...
//  .pipe(imagemin({ optimizationLevel: 0, progressive: true, interlaced: true }))
    .pipe(gulp.dest('../../../../m-platform/images'))
...
gulp.task('pug', function() {
    ...
    .pipe(gulp.dest('../../../../m-platform/html'))
});
...
//gulp.watch('src/sass/module/*.scss', ['styles2']);
 ...
 // Watch image files
  ...
  gulp.watch(['../../../../m-platform/sass/**','../../../../m-platform/html/**','../../../../m-platform/images']).on('del', livereload.changed);
