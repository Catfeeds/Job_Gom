(function(window){
    ...
    */
    function bluesalert(){
        ...
        //弹出对话框时的背景颜色
            ...
            alertFram[alertnum].style.maxWidth = "640px";
            ...
            alertFram[alertnum].style.borderRadius = ".2rem";

            strHtml = "<ul style=\"list-style:none;margin:0px;padding:0px;width:100%;background:#fff;display:-webkit-box;display:-moz-box;display:box;-moz-box-orient:vertical;-webkit-box-orient:vertical;box-orient:vertical;\">\n";
            strHtml += " <li style=\"text-align:center;font-size:1.6rem;color:#333;margin:2.5rem 0 2rem 0; \">"+title+"</li>\n";
            strHtml += " <li style=\"padding:0 2rem;margin-bottom:2rem;text-align: center;font-size: 1.3rem;\" >"+str+"</li>\n";
            strHtml += " <li style='height: 4.4rem;font-size: 1.6rem;line-height: 4.4rem;text-align: center;border-top: 1px solid #e6e6e6;' onclick='doOk("+alertnum+")'>确 定</li>\n";
            strHtml += "</ul>\n";
            ...
            alertFram[alertnum].style.marginTop=-alertFram[alertnum].clientHeight/20+'rem';
    ...
    */
    function bluesconfirm(){
        ...
        //弹出对话框时的背景颜色
            ...
            strHtml = "<ul style=\"list-style:none;margin:0px;padding:0px;width:100%;background:#fff;\">\n";
            strHtml += " <li style=\"text-align:center;font-size:1.6rem;margin: 2.5rem 0 2rem 0;color:#333;\">"+title+"</li>\n";
            strHtml += " <li style=\"padding:0 2rem;margin-bottom:2rem;text-align: center;font-size: 1.4rem;\" >"+str+"</li>\n";
            strHtml += " <li style='float:left;width: 50%;box-sizing:border-box;height: 4.4rem;font-size: 1.6rem;line-height: 4.4rem;text-align: center;border-right:1px solid #e6e6e6;border-top: 1px solid #e6e6e6;' id='cancle' data-value="+alertnum+">"+btn2+"</li>\n";
            strHtml += " <li style='float:left;width: 50%;height: 4.4rem;font-size: 1.6rem;line-height: 4.4rem;text-align: center;border-top: 1px solid #e6e6e6;'  onclick='doOk("+alertnum+")'>"+btn1+"</li>\n";
            strHtml += "</ul>\n";
            alertFram[alertnum].innerHTML = strHtml;
	...
	*/
	...
	//if(window.navigator.userAgent.toLowerCase().match(/MicroMessenger/i) == 'micromessenger' && location.href.indexOf("ttp://m."+(location.host.match(/gome\.com\.cn|atguat\.com\.cn/) ? "gome.com.cn" : "gomeplus.com")+"") != -1){
	if(window.navigator.userAgent.toLowerCase().match(/MicroMessenger/i) == 'micromessenger'){
		if(typeof(weixin_flag) != "undefined"){
			if(weixin_flag == 1){
				if((modelId != '' && ctl == 'product') || act == 'paid' || act == 'payment'){
					ctl = 'gift';
				}
				if(ctl != 'gift'){
					isWeixin();
