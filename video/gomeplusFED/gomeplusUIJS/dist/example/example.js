...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gomeplus = __webpack_require__(2);
	...
	document.querySelector('#toastBtn').addEventListener('click', function () {
	    _gomeplus2.default.ui.toast('正在加载...', {
	        duration: 3000,
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Created by liuxu-ds on 2017/3/13.
	 */
	exports.default = {
	  ui: _ui2.default,
	  util: _util2.default
...
/***/ function(module, exports, __webpack_require__) {
	...
	function toast() {
	    ...
	    var $toast = $toastWrap.find('.m-toast-logo');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _balajs = __webpack_require__(8);
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"<%= className %>\"> <div class=\"m-toast m-toast-logo\"> <div class=toast-hd> <div class=toast-logo></div> </div> <div class=toast-txt><%=content%></div> </div> </div> ";
...
/***/ function(module, exports, __webpack_require__) {
	...
	function actionSheet() {
	    ...
	    var $actionSheetWrap = (0, _util2.default)(_util2.default.render(_share2.default, options));
	    // $('.m-share-bottom').attr('bottom',0);
	    var $actionSheet = $actionSheetWrap.find('.m-share-bottom');
	    ...
	    (0, _util2.default)($actionSheet).attr('style', 'bottom:0');
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"<% if(isAndroid){ %>weui-skin_android <% } %><%= className %>\"> <div class=weui-mask></div> <div class=m-share-bottom> <ul class=share-list> <% for(var i = 0; i < menus.length; i++){ %> <li class=item> <a href=javascript:; class=\"<%= menus[i].class %>\"> <em class=share-icon></em> <p class=share-txt><%= menus[i].label %></p> </a> </li> <% } %> </ul> <% for(var j = 0; j < actions.length; j++){ %> <a href=javascript:; class=share-close><%= actions[j].label %></a> <% } %> </div> </div>";
