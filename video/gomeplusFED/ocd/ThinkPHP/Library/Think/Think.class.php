...
class Think {
    ...
    static public function appError($errno, $errstr, $errfile, $errline) {
      switch ($errno) {
          ...
          default:
            ...
            /*将错误写入自定义日志类*/
            $rsysMessage = array('message' => $errorStr);
            $rsysMessage['log_master'] = 'php';
            Rsyslog::write($rsysMessage, Rsyslog::NOTICE);
    ...
    static public function halt($error) {
        ...
        {
            $rsysMessage['message'] = $error;
        }
        $rsysMessage['log_master'] = 'php';
        Rsyslog::write($rsysMessage, Rsyslog::ERR);
