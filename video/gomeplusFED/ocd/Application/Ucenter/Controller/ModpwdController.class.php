...
class ModpwdController extends AuthController
{
	 ...
	 * @param：token			非必填，从cookie读取	string	第一步得到的token
	 * @param：mobile			非必填，从cookie读取	string	手机号
	...
	public function checkPsw()
	{
		...
		$newPwd = urldecode(I('param.newPwd'));
		// $newPwd = rsa_private_decrypt($newPwd);
		$newPwdConfirm = urldecode(I('param.newPwdConfirm'));
