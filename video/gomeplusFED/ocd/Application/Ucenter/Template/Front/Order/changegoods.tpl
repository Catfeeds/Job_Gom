...
<script>
    ...
    <div class="wrap-box">
	  ...
	  <if condition="$optype eq  1" >退货<else />换货</if>
	  </span></div>
        ...
        <tr>
          <th>
            <div class="apply-title clearfix">
              <h2>申请服务:</h2>
              <div class="trade-state-select"><span class="select-txt"data-node = "serviceType" >换货</span><em class="icon"></em>
			  <!--
                <div class="trade-state-select-list" data-node="TypeList" ><a href="javascript:;">1</a><a href="javascript:;">2</a><a href="javascript:;">3</a></div>
				-->
              </div>
            </div>
          </th>
        ...
        <tr>
          ...
          <td class="bordr">
			...
			<foreach name="vo.attributes" item = "attr" key = "k">
			  ...
			  <a href="javascript:void(0)" class="connect-shop" data-node = 'contactVendor' >联系商家</a>
            </div>
			</foreach>
