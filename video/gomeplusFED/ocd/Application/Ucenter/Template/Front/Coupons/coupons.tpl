          ...
          <ul class="clearfix">
			...
			<else /> <!--平台-->
              ...
              <div class="coupons-text">
					<p>发行店铺：<a href="<?php echo  $info['batchType'] == 1 ? shopDetailUrlGen($info['shop_id']) : $mall_domain.'search' ?>" target="_blank"><{$info['shop_name'] ? $info['shop_name'] : '国美+平台'}></a></p>
