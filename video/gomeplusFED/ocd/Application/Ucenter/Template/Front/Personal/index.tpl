        ...
        <div class="personal-info" data-node="editBox" <eq name="showType" value="2">style="display: none"</eq> >
            ...
            <ul>
                <li class="clearfix"><span class="info-label lh65">头像：</span>
                    <div class="head-img fl" data-action="editFaceImg"><img src="<?php echo getResizeImg($personalInfo['facePicUrl'], 75, 75) ? getResizeImg($personalInfo['facePicUrl'], 75, 75) : $pcimgpath.'/images/public/head-default.png'; ?>" data-node="faceImg"><span class="change-img">更换头像</span></div>
                </li>
                ...
                <li class="clearfix">
                    ...
                    <div class="nickname fl">
                        <input type="text" name="birthday" value="<{$personalInfo['birthday'] ? $personalInfo['birthday'] : '请选择'}>" class="fl" readonly style="cursor: pointer;" data-default="<{$personalInfo.birthday}>" data-node="showDate">
                ...
                <li class="clearfix"><span class="info-label">二维码：</span>
                    <div class="qr-code fl">
                        <div class="code-box"><img src="<{$personalInfo.genQrcodeUrl}>"></div>
                        <p>扫一扫  加好友  互关注</p>
                    </div>
                </li>
                    ...
                    <div class="picture-bj-img ">
                      <!-- 提示类 -->
                        ...
                        <div class="circle-default-head" data-node="cropWrap" >
                            <img src="<eq name='defaultFlag' value='1'><{$pcimgpath}>/images/public/circle-default-head.jpg<else/><{$personalInfo['facePicUrl']|getResizeImg=###,230,230}></eq>" alt="" data-default="<{$pcimgpath}>/images/public/circle-default-head.jpg" />
                        </div>
                ...
                <div class="head-preview-bx">
                    ...
                    <div class="picture2-bx">
                        <div class="picture-bx2">
                            <div class="default-img1" data-node="avatrSelector"><img src="<eq name='defaultFlag' value='1'><{$pcimgpath}>/images/public/default-img1.jpg<else/><{$personalInfo['facePicUrl']|getResizeImg=###,230,230}></eq>"></div>
                            <p class="p-size">160*160px</p>
                        </div>
                        <div class="picture-bx3">
                            <div class="picture-bx4">
                                <div class="default-img2" data-node="avatrSelector"><img src="<eq name='defaultFlag' value='1'><{$pcimgpath}>/images/public/default-img2.jpg<else/><{$personalInfo['facePicUrl']|getResizeImg=###,75,75}></eq>"></div>
                                <p class="p-size">60*60px</p>
                            </div>
                            <div class="picture-bx5">
                                <div class="default-img3" data-node="avatrSelector"><img src="<eq name='defaultFlag' value='1'><{$pcimgpath}>/images/public/default-img3.jpg<else/><{$personalInfo['facePicUrl']|getResizeImg=###,32,32}></eq>"></div>
