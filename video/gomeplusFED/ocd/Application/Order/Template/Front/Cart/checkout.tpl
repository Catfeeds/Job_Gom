...
<div class="wrap-box">
    ...
    <div class="address-editor" >
        ...
        <p class="unfold-bx">
            <a href="javascript:;" style="<?php if(count($addressList) <= 5) echo 'display:none;' ; ?>" data-action="expand"><span>展开</span><em></em></a>
        </p>
    </div>
    ...
    <div class="address-editor marg-b20">
        <div class="invoice-details">
            <p class="invoice-txt marg-r10"><a data-action="useTickets" href="javascript:;"><span class="looked-up">使用优惠券</span><em class="icon rotate">&#xe98c;</em></a></p>
            <p class="invoice-txt"><span data-node="ticketsDiscountName">已抵扣：</span><span data-node="ticketsDiscount" class="looked-up">￥0</span></p>
            <p class="invoice-txt marg-r10"><a data-action="useGomeCoin" href="javascript:;"><span class="looked-up">使用国美币</span><em class="icon rotate" data-node="gomeicon">&#xe98c;</em></a></p>
