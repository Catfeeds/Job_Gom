...
class LoginController extends BaseController
{
	...
	public function index()
	{
        ...
        if($this->userId)
		{
       	...
       	$getRedirect = isset($_GET['redirect']) ? $_GET['redirect'] : base64_encode($this->mx_domain['main']);
...
//		$param['snsUserName'] = $userInfo['nickname'];
     ...
     * @params：whereFrom，类型：STRING，必须：YES ，登陆来源 [qq、wechat、weibo]
	...
	public function snsBindPhonePage()
	{
		...
		$whereFrom = I('param.whereFrom', ''); // qq、wechat、weibo
     ...
     * @params：type，        类型：Int   ，必须：YES ，上一步返回，手机号对应的账号类型：1,已经是国美+用户；2，非国美+用户、国美在线用户；3，非国美+和国美在线用户
	...
	public function snsBindPhoneSecond()
	{
		...
		//手机号对应的账号类型：1,已经是国美+用户；2，非国美+用户、国美在线用户；3，非国美+和国美在线用户
        ...
        $param['password'] = urldecode($param['password']);
		//活动来源Id
