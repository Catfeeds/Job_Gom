<?php
   $csspath='/css/module/usercenter/usercenter.css';
    ...
    <div class="lg-main">
      ...
      <div class="lg-form">
        <ul class="lg-form-list" data-node="storeList">
          <div class="lg-error-tip hide clearfix" data-node="errorTip"><em class="icon icon-error">&#xe983;</em><span></span></div>
          <li class="clearfix lg-form-it">
            <label>门店会员账号</label>
            <div class="lg-form-cont">
              <em class="icon icon-right hide" data-node="okTip"></em>
