...
class LoginController extends BaseController {
	...
	const SCRF_CONTROLL_TIMES = 100;
	const SCRF_EXPIRE_TIME = 86400;
    ...
    public function login() {
		...
		$crsf_count_key = $ip.'_'.self::CSRF_ERR_CODE;
		$crsf_count = S($crsf_count_key);
		if($crsf_count>self::SCRF_CONTROLL_TIMES){
		...
		if($res['code'] == self::CSRF_ERR_CODE){
			setCounter($crsf_count_key,self::SCRF_EXPIRE_TIME);
		}
	...
	public function getCurrInfo()
	{
		...
		$returnArr['carProdNum'] 	= cartProductNumReal();
