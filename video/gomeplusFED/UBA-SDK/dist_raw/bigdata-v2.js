...
(function (win, doc, c) {
    if (!win.BP) {
        var h = doc.getElementsByTagName(c)[0], i = doc.createElement(c);
        i.async = !0;
        ...
        if (/pre|dev|test|atg|uat/.test(host)) {
            i.src = '//js.uatplus.com/sitemonitor/uba-sdk.min.js?v=9442895533';
        }
        else {
            i.src = '//js.gomein.net.cn/sitemonitor/uba-sdk.min.js?v=9442895533';
        }
...
/* dev-only start */
if (window['testinfo']) {
    var originurl = decodeURIComponent(window.location.href.split('&')[0].split('=')[1]);
    var temp = originurl.match(/https?:\/\/(.+?)\//);
...
gomeClicki('set', (function () {
    ...
    if (document.referrer != "")
        customer.dimension3 = document.referrer;
    // 产品与品类相关信息
    ("undefined" != typeof dsp_gome_c1name) && (customer.dimension4 = dsp_gome_c1name,
    ...
    ("undefined" != typeof prdInfo) && (customer.dimension4 = prdInfo.firstCategoryName,
        ...
        customer.metric1 = 1);
    ("undefined" != typeof itemId) && (customer.dimension15 = itemId,
        "undefined" != typeof prodid) && (customer.dimension9 = prodid);
    var _cshop = document.getElementById('c8_shop_mId');
...
var __c_visitor = cookie("__c_visitor");
...
if (window._wall_switch === undefined) {
    // 10402
    window.setTimeout(function () {
        (function (a, b, c, d, e, f) {
            ...
            i.async = !0, i.src = '//js.gomein.net.cn/sitemonitor/10402.js';
            h.parentNode.insertBefore(i, h);
...
(function (a, b, c, d, e, f) {
    ...
    a.tagmangerGlobalObject = e, g[f] = { dlName: d };
    var h = b.getElementsByTagName(c)[0], i = b.createElement(c);
    i.async = !0, i.src = '//js.gomein.net.cn/sitemonitor/10119.js';
    h.parentNode.insertBefore(i, h);
