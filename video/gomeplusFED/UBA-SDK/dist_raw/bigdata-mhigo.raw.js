/*
 * bigdata-mhigo v1.0.0, bundle: 2017-06-12 10:44
 * (c) 2017 gomeBigData
 */
(function () {
(function (win, doc, c) {
    if (!win.BP) {
        ...
        if (/pre|dev|test|atg|uat/.test(host)) {
            i.src = '//js.uatplus.com/sitemonitor/uba-sdk.min.js?v=1318044645';
        }
        else {
            i.src = '//js.gomein.net.cn/sitemonitor/uba-sdk.min.js?v=1318044645';
        }
