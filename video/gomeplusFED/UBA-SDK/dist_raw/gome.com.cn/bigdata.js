/*
 * sitemoniter-gomecom v1.0.4, bundle: 2017-05-27 13:53
 * (c) 2017 gomeBigData
 */
(function () {
(function (win, doc, c) {
    if (!win.BP) {
        ...
        if (/pre|dev|test|atg|uat/.test(host)) {
            i.src = '//js-pre.meixincdn.com/m/UBA-SDK/dist/uba-sdk.min.js?v=3011183314';
        }
        else {
            i.src = '//js.gomein.net.cn/sitemonitor/uba-sdk.min.js?v=3011183314';
        }
...
/* 发送stm v4 pv */
window.gomeClicki('create', document.location.href.search(/\.gome\.com\.cn/) < 0 ? "dc-6" : "dc-1", "auto", {
    clientId: (function (a) {
