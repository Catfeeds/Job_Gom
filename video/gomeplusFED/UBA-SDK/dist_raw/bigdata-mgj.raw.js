/*
 * bigdata-mgj v1.0.0, bundle: 2017-06-27 17:17
 * (c) 2017 gomeBigData
 */
(function () {
(function (win, doc, c) {
    if (!win.BP) {
        ...
        if (/pre|dev|test|atg|uat/.test(host)) {
            i.src = '//js.uatplus.com/sitemonitor/uba-sdk.min.js?v=6125766956';
        }
        else {
            i.src = '//js.gomein.net.cn/sitemonitor/uba-sdk.min.js?v=6125766956';
        }
...
/* 发送stm v4 pv */
window.gomeClicki('create', /pre|dev|test|atg|uat/.test(window.location.host) ? "dc-7" : "dc-14", "auto"
/*, {
    clientId: (function(a) {
