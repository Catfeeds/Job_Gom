	...
	<div id="browser_ie">
		<div class="brower_info">
			<div class="notice_info">
				<p>你的浏览器为${res.t}，版本过低！<br>请升级或更换您的浏览器。</p>
			</div>
			<div class="browser_list">
				<span>
					<a href="http://www.chromeliulanqi.com/" target=_blank><img src="${baseurl}chrome.png"><br>chrome </a>
				</span>
				<span>
					<a href="http://www.firefox.com.cn/" target=_blank><img src="${baseurl}firefox.png"><br>firefox </a>
				</span>
				<span>
					<a href="http://www.apple.com/safari/" target=_blank><img src="${baseurl}safari.png"><br>safari </a>
				</span>
				<span>
					<a href="https://www.microsoft.com/zh-cn/download/internet-explorer.aspx" target=_blank><img src="${baseurl}ie.png"><br>ie10及以上 </a>
				</span>
			</div>
		</div>
	</div>
