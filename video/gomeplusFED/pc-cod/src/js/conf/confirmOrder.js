...
/***/ function(module, exports, __webpack_require__) {
	...
	var address = __webpack_require__(92);
	var useTickets = __webpack_require__(96);
	var invoice = __webpack_require__(105);
	var buyersMsg = __webpack_require__(107);
	var submitOrder = __webpack_require__(108);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var userCardTips = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @author Zhengchun Fu
	 */
	var tipsTpl = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$out+=' <div class="order-edit-box" data-node="editUserCardTips"> <div class="order-edit-text clearfix"><em class="icon">&#xe983;</em><span>订单中含有跨境商品，需点击<br/><a href="javascript:;" data-action="editUserCard">编辑</a>完善身份信息！</span></div> <div class="order-edit-san"></div> </div> ';
	}else{
	$out+=' <div class="order-edit-box" data-node="userCardTips"> <div class="order-edit-text clearfix"><em class="icon">&#xe983;</em><span>订单中含有跨境商品，需点击编辑完善身份信息！</span></div> <div class="order-edit-san"></div> </div> ';
	}
	return new String($out);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fenToYuan = __webpack_require__(97);
	var ticketsTpl = __webpack_require__(98);
	var Dialog = __webpack_require__(22);
	var Pubsub = __webpack_require__(43);
	var channel = __webpack_require__(68);
	var fetch = __webpack_require__(2);
	var url = __webpack_require__(28);
	var findBestTicket = __webpack_require__(99);
	var gomeCoin = __webpack_require__(100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$out+=' <div> <div class="shop"><em class="icon icon-shop">&#xe9df;</em>';
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * 确认订单页--优惠券--使用国美币
	 */
	var gomeCoinTpl = __webpack_require__(101);
	var Dialog = __webpack_require__(22);
	var Pubsub = __webpack_require__(43);
	var channel = __webpack_require__(68);
	var f2Y = __webpack_require__(97); // 分转成元

	// tmod helpers
	__webpack_require__(102)();

	var getOrderShops = __webpack_require__(103);
	var orderShops = getOrderShops();
	var orderShopsLength = orderShops.length;
	var orderShopsPrev = [];
	var orderShopsLast = [];

	var goodsTotalPrice = parseFloat($('[data-node=goodsTotalPrice]').data('goodstotalprice'));

	var gomeCoin = $GLOBAL_CONFIG.gomeCoin;
	// gomeCoin 是页面输出的变量
	// var gomeCoin = {
	// 	"totalRebate": 901.00, //总共国美币
	// 	"useableRebate": 20.00 //可用国美币
	// };
	...
	canUseCoinPrice = canUseCoinPrice;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getOrderList = function() {
		var orderList = $GLOBAL_CONFIG.orderList;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {var Pubsub = __webpack_require__(43);
	var channel = __webpack_require__(68);
	var confirm = __webpack_require__(53);
	var invoiceTpl = __webpack_require__(106);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**/) {
	'use strict';var $utils=this,$helpers=$utils.$helpers,type=$data.type,$escape=$utils.$escape,title=$data.title,$out='';$out+='<div class="ui-body-box"> <div class="invoice-box"> <h3 class="radio-title">发票类型：</h3> <div class="invoice-flot-lft"> <label data-node="noInvoice" data-type="0"><span class="menu-radio ';
	if(type==0){
	$out+='menu-radio-checked';
	}
	...
	$out+='"></span>单位</label> </div> </div> <div class="please-enter"><em data-action="clear" class="icon close">&#xea5a;</em> <input data-node="invoiceInfo" data-type="';
	$out+=$escape(type);
	$out+='" type="text" value="';
	$out+=$escape(title);
	$out+='" placeholder="请输入发票抬头" class="input-error"> <p class="error"><em class="icon">&#xe961;</em>请输入发票抬头信息</p> </div> <p class="invoice-content">发票内容：由供应商自行确定发票内容</p> </div> </div>';
	return new String($out);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var init = function() {
		// 更新发票数据
		Pubsub(channel.confirmOrder.invoice).sub(function(data) {
