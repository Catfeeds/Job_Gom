...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {__webpack_require__(130);
	var checkPub = __webpack_require__(157);

	// 发送统计数据用
	var buriedPoint = __webpack_require__(54);
	buriedPoint.setPageData('home');

	var advArr = $GLOBAL_CONFIG['advert'] || [],
		topArr = $GLOBAL_CONFIG['topAd'],
		ggArr  = $GLOBAL_CONFIG['ggAd'];
	...
	function renderTopli(arg){					//渲染 大焦点图轮播节点
		var con = $.parseJSON(arg.content),
			str = '<li>'
				+'<a target="_blank" href="'+ con.clickUrl 
		...
		for(var i = 0;i<len;i++){
			...
			if ($obj.find('li').length > 1) {
				$obj.bxSlider({ 
					adaptiveHeight: true,
					startSlide: 0,
					prev: '<em class="icon icon-left">&#xe970;</em>',
					next: '<em class="icon icon-right">&#xe98c;</em>',
					infiniteLoop: true,
					auto: true
				});
			}else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {var loginPop = __webpack_require__(3);	//登录弹窗
