<div class="pluspc-homeTopic-box " data-small="pluspc-homeTopic-boxS">
    <div class="homeTopic-box-cont clearfix ">
        <div class="cont-hotTop fl" tpl-cms-node="homeshottopic" id="homeshottopic">
            <div class="hotTop-title clearfix">
                <h3 class="fl"><{$homesTopicSlot.name}></h3>
                <p class="fr ">
                    <a class="hotTop-publish"  href="<{$mx_domain.group}>topic/publiser" target="_blank" data-code="home01001-publiser">发布话题></a>
                </p>
            </div>
            <ul class="clearfix">
                <foreach name="homesHotTopics" item="hotTopic" key="topicKey">
                <li>
                    ...
                    <div class="hotTop-matter">
                        <div class="matter-title">
                            <a href="<{$hotTopic.topic_id|topicDetailUrlGen}>" target="_blank" title="<{$hotTopic.cmsName}>" data-code="home01001-<{$topicKey+1}>"><{$hotTopic.cmsName}></a>
                        </div>
        ...
        <div class="cont-interest fr" tpl-cms-node="homesinterestgroup" id="homesinterestgroup">
            <div class="interest-title clearfix">
                <h3 class="fl"><{$homesGroupSlot.name}></h3>
                <p class="fr ">
            ...
            <div class="interest-cont">
                <div class="interest-wrap" data-node="interest-wrap">
                    <ul class="clearfix interest-list" data-node="interest-list">
                        <foreach name="homesInterestGroup" item="interestGroup" key="groupKey">
                        <li data-node="interest-listLi">
                            ...
                            <div class="list-txt-t clearfix">
                                <span class="txt-title">
                                    ...
                                    <a target="_blank" href="<{$interestGroup.group_id|groupDetailUrlGen}>" title="<{$interestGroup.cmsName}>" data-code="home01002-<{$groupKey+1}>"><?=mb_substr($interestGroup['cmsName'],0,8)?></a>
                                </span>
                                <span class="txt-num">
