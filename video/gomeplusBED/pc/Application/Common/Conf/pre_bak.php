...
return array(
	...
	/*前端页面配置*/
	'STATICPATH' => array(
		'JS' => 'js.dev.meixincdn.com:1314/CDN8130/',
		'CSS' => 'js.dev.meixincdn.com:1314/CDN8130/',
		'IMG' => 'js.dev.meixincdn.com:1314/CDN8130/',
	...
	/* 数据缓存设置 */
	'DATA_CACHE_TIME' => 60,			// 数据缓存有效期 0表示永久缓存，单位（秒）
	'DATA_CACHE_COMPRESS' => false,		// 数据缓存是否压缩缓存
	'DATA_CACHE_CHECK' => false,		// 数据缓存是否校验缓存
	'DATA_CACHE_PREFIX' => 'mx_pc_',	// 缓存前缀
	'PREDIS_EXCEPTIONS' => 0,
	'PREDIS_CLUSTER_MODE' => false,		// cluster
	...
	'UCENTER_URL'=>'ucenter.gomeplus.com/',
	'MALL_URL' => 'mall.gomeplus.com/',
	'MAIN_URL' => 'www.gomeplus.com/',
	'API_url'  => 'api.gomeplus.com/'
     // 错误定向页面,只有APP_DEBUG=false时生效
    'ERROR_PAGE'     =>  APP_HTTP.'www.baidu.com',
	...
	'UBA_SDK_URI' => '/m/UBA-SDK/dist/uba-sdk.min.js',
	 ...
	 'GOME'=>[
        ...
        /*API接口配置*/
        'SERVICE' => array(
            'DOMAIN' => 'http://api.bs.pre.atguatplus.com/api/',
