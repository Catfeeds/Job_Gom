...
class ErrorCode {
    ...
    const MSHOP_POST_NAME_LEN = '711001';
    const MSHOP_POST_DESC_LEN = '712001';
    const MSHOP_NO_OPEN = '713001';
    ...
    public static $statusCode = array(
        ...
        self::MSHOP_POST_NAME_LEN => '最大可输入15个汉字',
        self::MSHOP_POST_DESC_LEN => '最大可输入100个汉字',
        self::MSHOP_NO_OPEN => '请先开通美店',
