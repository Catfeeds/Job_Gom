    ...
    <div class="lg-main">
      ...
      <div class="lg-form clearfix">
        ...
        <div class="lg-succ-right">
          ...
          <p class="lg-succ-para">恭喜您，您的国美账号：<span data-node = "user_id" ><{$mobile}> <br></span>可用于登录国美 APP / wap / pc端 </p><a data-node = "btn_next" href="<?php echo $passport_domain.'login/index'; ?>" class="lg-btn-bor">去登录</a>
        </div>
      </div>
    </div>
