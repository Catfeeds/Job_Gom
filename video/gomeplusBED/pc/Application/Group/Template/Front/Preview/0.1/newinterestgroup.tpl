...
<div class="interest-cont">
    <div class="interest-wrap" data-node="interest-wrap">
        <ul class="clearfix interest-list" data-node="interest-list">
            <volist name="datalists" item="interestGroup" key="groupKey" offset="0" length='3'>
                <li data-node="interest-listLi">
                    ...
                    <div class="list-txt-t clearfix">
                                <span class="txt-title">
                                    ...
                                    <a target="_blank" href="<{$interestGroup.group_id|groupDetailUrlGen}>" title="<{$interestGroup.name}>" data-code="fresh01002-<{$groupKey+1}>"><?=mb_substr($interestGroup['name'],0,8)?></a>
                                </span>
                        <span class="txt-num">
