...
class CropController extends BaseController
{
    ...
    public function crop_img()
	{
        ...
        if( $_POST['type'] == 'crop' ) {
            //裁剪尺寸
            empty($_POST['dest_width']) ? $_POST['dest_width'] = 220 : '';
            empty($_POST['dest_height']) ? $_POST['dest_height'] = 220 : '';
            ...
            if( !isset( $_POST['avatar_src'] ) ) $_POST['avatar_src'] = '';
    ...
    /**
     * 裁图，跟头像裁图功能类似（头像裁图固定尺寸220*220，此接口会保留原始裁图尺寸）
     * @param $avatar_src string 源地址
     * @param $avatar_data josn 裁图位置 x,y,height,width
     * @param $_FILES array 图片信息
     * @return josn
     */
    public function crop_img_real_size()
    {
        $_POST['dest_width'] = 844;
        $_POST['dest_height'] = 422;
        $this->crop_img();
    }
}