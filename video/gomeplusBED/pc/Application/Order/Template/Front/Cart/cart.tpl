                    ...
                    <td colspan="5" class="align-left volume-pop">
                        <div class="check-all">
                            ...
                            <?php if($shop['hasCoupon']):?>
                                <a data-shopId="<?=$shopId;?>" data-action="showTickets" href="javascript:;" class="volume">领券<em class="iconn-2 volume-icon-down"></em></a>
                            <?php endif;?>
                        </div>
                        <?php if($shop['hasCoupon']):?>
	...
	<table class="shop-car-list shop-car-fail <eq name='tableHideFlag' value='1'>hide</eq> ">
		<tr class="bor-bom">
			<td colspan="5" class="align-left">
				<div class="check-all"><em class="icon iconn-44"></em><a href="<{$shopIdInv|shopDetailUrlGen}>" target="_blank"><span class="store-name-text"><{$shopInva.title}></span></a></div>
			</td>
		</tr>		
