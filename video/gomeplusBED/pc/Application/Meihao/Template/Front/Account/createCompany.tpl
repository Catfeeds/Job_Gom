  ...
  <include file="Account:header"/>
    <div class="perfect-company company">
      ...
      <div class="company-info" data-node="companyInfo">
        <div class="info clearfix">
          ...
          <div class="info-right">
            <input class="right-name" type="text" data-node="companyName">
        ...
        <div class="info clearfix">
          ...
          <div class="info-right">
            <input class="right-name" type="text" data-node="licenseNum">
        ...
        <div class="info clearfix">
          ...
          <div class="info-right">
            <div data-node="uploadBox" class="licensePic">
                <div class="upload-pic" data-node="upload"></div>
                <div data-defaultaddFile="picker"><div class="right-img"><a href=""></a></div></div>
            </div>
        ...
        <div class="info clearfix">
          ...
          <div class="info-right">
            <input class="right-name" type="text" data-node="userName">
        ...
        <div class="info clearfix">
          ...
          <div class="info-right" data-node="tipsUserId">
            <input class="right-name" type="text" data-node="userId">
        ...
        <div class="info clearfix">
          ...
          <div class="info-right">
            <input class="right-name" type="text" data-node="phone">
        ...
        <div class="info clearfix">
          ...
          <div class="info-right">
            <input class="right-name" type="text" data-node="email">
      ...
      <div class="choose-btn clearfix">
        ...
        <div class="back"><a href="/account/type">返回</a></div>
      </div>
    </div>
