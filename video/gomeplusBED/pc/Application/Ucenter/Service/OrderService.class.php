...
class OrderService extends BaseService
{
	...
	public $order_orderDeliveryLogistics = 'trade/orderDeliveryLogistics'; //GET 配送单物流信息列表 T11
	public $order_deliveryConfirmation = 'trade/orderDeliveryConfirmationAction'; //POST 确认收货
	...
	public $afterSaleTypes = "trade/afterSalesTypes";//检查国美在线商品是否有退换货的权限T44
	public $buyerCollectionConfirmation= "trade/buyerCollectionConfirmation";//T45确认上门取货
}
