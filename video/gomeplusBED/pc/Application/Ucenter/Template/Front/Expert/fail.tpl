...
<div class="talent-content">
	<div class="talent-content-info">
		<ul>
			<li class="clearfix"><i class="icon_t icon-username"></i><span>真实姓名 :</span><strong><{$result['realName']}></strong></li>
			<li class="clearfix"><i class="icon_t icon-phone"></i><span>联系方式 :</span><strong><{$result['mobile']}></strong></li>
			<li class="clearfix"><i class="icon_t icon-talent-type"></i><span>达人类别 :</span><strong><{$result['category']['name']}></strong></li>
			<li class="clearfix"><i class="icon_t icon-introduce"></i><span>个人介绍 :</span><strong class="introduce"><{$result['introduction']}></strong></li>
			<li class="clearfix"><a class="update-message" href="/expert/index?apply=1">修改</a></li>
		</ul>
	</div>
</div>
