...
<script>
window._page_name_ = '个人中心-商品收藏';
window._page_id_ = 'F006';
</script>
<div class="wrap-box mart20 clearfix">
	<include file="Front/Public/left" />
	<div class="user-right">
		<div class="usershop-title">
			<div class="left-tab" data-node="tabList"><a href="<{$i_domain}>collect/goods" class="active" data-type="goods">商品</a><a href="<{$i_domain}>collect/shop" data-type="shop">店铺</a><a href="<{$i_domain}>collect/topic" data-type="topic">话题</a></div>
		...
		<div class="shop-list" data-node="collectList">
			<ul class="clearfix" data-node="dataList"></ul>
		</div>
		<div class="more-comments hide" data-node="loadedMore"><a href="##" class="clearfix" data-action="loadMore"><span><img src="<{$pcimgpath}>/images/circle/small-logo.png">点击加载更多<em class="iconn-9"></em></span></a></div>
