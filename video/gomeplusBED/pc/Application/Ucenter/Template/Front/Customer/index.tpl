	...
	<include file="Front/Public/left" />
      <div class="order-right">
		...
		<div class="more-comments" data-node="loadList" data-page="1">
			<a href="javascript:;" class="clearfix"><span><img src="<{$pcimgpath}>/images/circle/small-logo.png?v=<?php echo C('JS_VERSION'); ?>">点击加载更多<em class="icon icon-right">&#xe98c;</em></span></a>
		</div>
