          ...
          <td colspan="3" class="align-left">
            <div class="check-all">
              <div class="shop-arl-check icon-fontsize"><em class="iconn-64"></em></div>
      			  <a target="_blank" href="<{$item_orders.shop.id|shopDetailUrlGen}>" class="store-name-text"><{$item_orders.shop.name}></a>
      			   <!--国美在线不显示联系商家-->
              <if condition="$list.status neq 0 ">
        			  <if condition="$list.orderType neq 6 &&  $list.orderType neq 7">
                <a  href="<?=imUrl('shop',$item_orders['shop']['id'])?>" data-action="entryBtn" target="_blank" class="connect-shop"><p>联系商家</p></a>
                <else />
