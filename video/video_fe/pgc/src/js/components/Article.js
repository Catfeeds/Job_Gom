...
class Article extends Component{
    ...
    this._isMounted = true
		...
		// this.editor = 'editor'+Math.random().toString().substr(2);
	...
	reset = () => {
		this.setState({
			...
			editor.setContent('');
			editor.document.body.innerHTML = '<p></br></p>';
			//editor.setContent('');
			...
			<div className="upload-form">
				<div className="form">
					...
					<div className="article-update-btns">
						...
						{this.state.article_id ? <Link to="/portal/contentManage" className="au-btn article-update-cancel">取消</Link> : ''}
					</div>
				</div>
			</div>
  		</div>
