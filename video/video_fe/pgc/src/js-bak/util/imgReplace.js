...
export const imgReplace = function(src) {
   return  src.replace(rules, '');
}

export const orignalImgReplace = function(src){
...
export const addShortCut = function(src){
   return src.replace(imgType,function($1){
       return shotCut + $1;
   })
}

export const imgProto = function(src) {
...
export const changeSrc = function(container) {
