...
import VideoSubDialog from "./VideoSubDialog";
...
class AddORmodefierSub extends Component{
    constructor(props){
        super(props);
        this.form = {
    ...
    render(){
        ...
        return (
            ...
            >
                <div className="messageContain" style={{width:620+'px', maxHeight:280+'px'}}>
...
export  default AddORmodefierSub
